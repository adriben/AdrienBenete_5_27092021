...
function displayCameras(camera) { //fonction pour faire apparaitre les cameras sur la page
    ...
    <article class="card col-12 col-md-4 m-5 mt-4 p-0 pb-2 shadow">
      ...
      <div class="card-body">
        ...
        <a class="btn btn-primary cameraLink stretched-link" href="/frontend/pages/article.html?id=${camera._id}">Details du produit</a>
      </div>
      </div>
    </article>
    `;
